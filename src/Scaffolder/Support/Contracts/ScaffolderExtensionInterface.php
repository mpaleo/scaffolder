...
namespace Scaffolder\Support\Contracts;

interface ScaffolderExtensionInterface
{
    /**
     * This extension is run after the model is compiled.
     *
     * @param $compiledStub
     * @param $modelData
    ...
    /**
     * This extension is run after the controller is compiled.
     *
     * @param $compiledStub
     * @param $modelData
     * @param $scaffolderConfig
    ...
    /**
     * This extension is run after the migration is compiled.
     *
     * @param $compiledStub
     * @param $modelData
     * @param $scaffolderConfig
