...
class WelcomeViewCompiler extends AbstractViewCompiler
{
    /**
    ...
    public function compile($stub, $modelName, $modelData, stdClass $scaffolderConfig, $hash, ScaffolderThemeExtensionInterface $themeExtension, $extra = null)
    {
        ...
        return $this->store(null, $scaffolderConfig, $themeExtension->runAfterWelcomeViewIsCompiled($this->stub, $scaffolderConfig), new FileToCompile(null, null));
    }
